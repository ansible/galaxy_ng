...
pytest \
    --capture=no \
    -m "not cloud_only and not community_only and not rbac_roles and not iqe_rbac_test and not sync and not certified_sync and not xreposearch and not rm_sync and not rbac_repos" \
