...
pytest --capture=no --tb=short -m "not standalone_only and not community_only and not rbac_roles and not iqe_rbac_test and not sync and not rm_sync and not xreposearch" $@ -v galaxy_ng/tests/integration
RC=$?
