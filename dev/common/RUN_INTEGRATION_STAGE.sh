...
pytest --log-cli-level=DEBUG -m "not standalone_only and not community_only and not rbac_roles and not slow_in_cloud and not sync" --junitxml=galaxy_ng-results.xml -v galaxy_ng/tests/integration
