...
echo "- [#forum-aap-testing-framework](https://redhat.enterprise.slack.com/archives/C04PF3DL9FF)"
echo "- [#aap-ui](https://redhat.enterprise.slack.com/archives/C01HQHP1GFW)"
echo "- [#wg-ansible-content-integration](https://redhat.enterprise.slack.com/archives/C07S39P2MJC)"
