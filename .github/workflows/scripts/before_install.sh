...
git clone --depth=1 https://github.com/pulp/pulpcore.git --branch 3.17.4
...
git clone --depth=1 https://github.com/pulp/pulp_ansible.git --branch 0.12.0
cd pulp_ansible
...
git clone --depth=1 https://github.com/pulp/pulp_container.git --branch 2.10.0
cd pulp_container
