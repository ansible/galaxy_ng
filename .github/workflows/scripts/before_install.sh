...
git clone --depth=1 https://github.com/pulp/pulpcore.git --branch 3.23
...
git clone --depth=1 https://github.com/pulp/pulp_container.git --branch 2.14.3
cd pulp_container
...
git clone --depth=1 https://github.com/ansible/galaxy-importer.git --branch v0.4.6
cd galaxy-importer
