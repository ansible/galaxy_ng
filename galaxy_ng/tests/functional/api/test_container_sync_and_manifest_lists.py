...
class ContainerSyncandManifestListTestCase(TestCaseUsingBindings):
    ...
    - perform sync
    - verify that the repo has two images with tags ml_i and manifest_a, that manifest_a
      is a manifest and that ml_i is a manifest list with two manifests in it
