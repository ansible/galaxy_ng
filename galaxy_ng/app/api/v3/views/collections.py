...
from galaxy_ng.app.utils.roles import get_path_role_version
from galaxy_ng.app.utils.roles import get_path_role_name
from galaxy_ng.app.utils.roles import get_path_role_namespace
from galaxy_ng.app.utils.roles import path_is_role
...
class GitSyncCollectionView(api_base.ViewSet):
...
class GitImport:
    ...
    def create(self):
        ...
        #async_task = call_move_content_task(cv, repository, staging)

        #####################################
        # copy bits from staging to published
        #####################################
        published =  AnsibleDistribution.objects.get(name="published").repository
        async_task = call_move_content_task(cv, repository, published)
