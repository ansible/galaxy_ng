...
from pulp_container.app.registry_api import BearerTokenView
...
class KeycloakBasicAuth(BasicAuthentication):
    def authenticate_credentials(self, userid, password, request=None):
        ...
        if response.status_code == http_code.HTTP_200_OK:
            ...
            # TODO: How do you verify JWT signature and audience? 
            token_data = jwt.decode(response.json()['access_token'], options={
            ...
            raise exceptions.AuthenticationFailed(_("Invalid username and password."))


class ContainerRegistryTokenView(BearerTokenView):
    authentication_classes = [KeycloakBasicAuth, ]
